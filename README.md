...
=======
# TSA Decomposition (Modeling of U.S. Treasury Yield Curve)
Expanding on Machine Learning Modeling for Time Series Analysis

## Overview

Compelete this later.

---

## Data Source

Data is obtained from the Federal Reserve Economic Data (FRED) database maintained by the Federal Reserve Bank of St. Louis.
...
Original data link: https://fred.stlouisfed.org
Data updated: 2026-02-18
...
Data usage is subject to FRED terms of use:
